...
const initialState: TransferState = {
  ...
  diversifiWalletAddress: undefined,
};
...
export const transferSlice = createSlice({
  ...
  reducers: {
    ...
    setDiversifiWalletAddress: (state, action: PayloadAction<string | undefined>) => {
      state.diversifiWalletAddress = action.payload;
    },
