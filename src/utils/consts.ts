...
export const getDefaultNativeCurrencySymbol = (chainId: ChainId) =>
  chainId === CHAIN_ID_SOLANA
    ? "SOL"
    : chainId === CHAIN_ID_ETH || chainId === CHAIN_ID_ETHEREUM_ROPSTEN || chainId === RINKEBY_ETH_NETWORK_CHAIN_ID
    ? "ETH"
...
export const ETH_BRIDGE_ADDRESS = getAddress(
  CLUSTER === "mainnet"
    ...
    : "0x369b28f227C0188478cb05F8467bdd52002EcC4E"
);
...
export const SOL_BRIDGE_ADDRESS =
  CLUSTER === "mainnet"
    ...
    : "DRmLANN1qXBELs69gW5upY4qH4iWc23MTcRPjDuzZYuH";
...
export const COVALENT_GET_TOKENS_URL = (
  ...
  const chainNum =
    chainId === CHAIN_ID_ETH || chainId === 5
      ? COVALENT_ETHEREUM
      : chainId === CHAIN_ID_BSC
      ? COVALENT_BSC
      : chainId === CHAIN_ID_POLYGON
